...
export async function createBacktestRun(req: Request, res: Response): Promise<void> {
  ...
  const model = await repo.getModelMeta(body.model_id);
  if (!model) {
...
export async function getBacktestRun(req: Request, res: Response): Promise<void> {
...
export async function listBacktestResults(req: Request, res: Response): Promise<void> {

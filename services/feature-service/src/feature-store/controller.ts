...
export function makeFeatureController(repo: FeatureStoreRepository, cron: MaterializationCron) {
  ...
  async function getBatch(req: Request, res: Response): Promise<void> {
  ...
  async function materialize(req: Request, res: Response): Promise<void> {
  ...
  return { getOne, getBatch, materialize };
}

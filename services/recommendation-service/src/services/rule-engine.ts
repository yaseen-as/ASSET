...
import type { OHLCV, Signal, Exchange } from '@platform/shared';
 ...
 * Evaluates technical analysis rules against OHLCV data
 */
export class RuleEngine {
  evaluate(symbol: string, exchange: Exchange, candles: OHLCV[]): RuleResult[] {
    ...
    // 1. Golden/Death Cross (SMA 50 vs SMA 200)
  ...
  private checkEMATrend(closes: number[]): RuleResult | null {
    ...
    // Check if price has been above EMA20 for 5 consecutive days

...
import type { FeatureVector, ModelName, ScoreResult } from '../types';
...
// to request from feature-service and which score table to write into.
export class ScorerService {
  ...
  async scoreUniverseMeta(exchange: string, date: string, topN = 50): Promise<ScoreResult[]> {
    ...
    // Pull per-component scores already persisted for `date`
